export const ITEM_CONSTANTS = {
  ...
  reqRating: [
    ...
    '需要个人和团队竞技场评分达到%d',
    '需要在3v3或5v5比赛中个人和团队竞技场评分达到%d',
    '需要在5v5比赛中个人和团队竞技场评分达到%d',
  ],
  quality: [
    // ITEM_QUALITY?_DESC
    '粗糙',
...
export const SPELL_TRIGGERS = ['使用', '装备', '击中时可能', '未知', '灵魂石', '无延迟使用', '学习法术ID'] as const;
